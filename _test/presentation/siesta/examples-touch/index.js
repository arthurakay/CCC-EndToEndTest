...
Harness.start(
    {
        ...
        items : [
            ...
            '020-sencha_touch_2.x/017_tabs.t.js',
            {
                ...
                hostPageUrl     : '020-sencha_touch_2.x/DemoApp/',
                performSetup    : false,       // This is done by the app itself
                preload         : [],
                items           : [
                    '020-sencha_touch_2.x/application_tests/100_sanity.t.js',
                    '020-sencha_touch_2.x/application_tests/101_login.t.js',
                    '020-sencha_touch_2.x/application_tests/102_logout.t.js'
                ]
            }
        ]
    }
