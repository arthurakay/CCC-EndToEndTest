...
var harnessPreload  = [
    '../../extjs-4.1.1/resources/css/ext-all.css',
    '../../extjs-4.1.1/ext-all-debug.js',
    '../siesta-all.js',
    'lib/Siesta/Test/AssertionsTranslator.js',
    {
        text        : 'Siesta.Result.seedID(1000000000)'
    }
]
...
Harness.start(
    ...
    '046_type_with_options.t.js',
    '047_enter_in_form.t.js',
    '201_function.t.js',
    {
        group               : 'Visual tests',
...
//            '540_extjs_type.t.js?Ext3',
    ...
    },
    {
        ...
        items               : [
            ...
            '603_siesta_ui.t.js',
            '604_siesta_ui2.t.js',
            '605_siesta_ui_nbr_layouts.t.js',
            '606_siesta_preload_404.t.js'
        ]
    },
